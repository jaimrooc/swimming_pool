...
-- DATOS_CLASES
ALTER TABLE DATOS_CLASES ADD CONSTRAINT pk_d_c_datos_clase PRIMARY KEY (clase, alumno);
ALTER TABLE DATOS_CLASES ADD CONSTRAINT fk_d_c_clase FOREIGN KEY (clase) REFERENCES CLASES(codigo);
ALTER TABLE DATOS_CLASES ADD CONSTRAINT fk_d_c_alumno FOREIGN KEY (alumno) REFERENCES ALUMNOS(identificacion);
